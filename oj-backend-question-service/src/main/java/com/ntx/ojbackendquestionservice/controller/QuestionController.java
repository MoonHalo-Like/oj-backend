package com.ntx.ojbackendquestionservice.controller;
...
import com.ntx.ojbackendmodel.model.dto.question.*;
...
import com.ntx.ojbackendmodel.model.vo.QuestionVO;
...
public class QuestionController {
    ...
    public BaseResponse<Page<QuestionVO>> listQuestionVOByPage(@RequestBody QuestionQueryRequest questionQueryRequest,
        ...
        Page<Question> questionPage = questionService.page(new Page<>(current, size),
                questionService.getQueryWrapper(questionQueryRequest));
        List<QuestionVO> questionVOList = questionPage.getRecords().stream().map(QuestionVO::objToVo).collect(Collectors.toList());
